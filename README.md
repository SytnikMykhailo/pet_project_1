...
📋 Project Overview
A client-server application for generating procedural noise images using Perlin noise algorithm. Multiple clients can connect simultaneously to request custom noise-based images in various formats (BMP, PNG, JPEG). Built for Windows OS using modern C++ and networking technologies.
